...
using TheSchlote.TaskManager.Core.ProjectAggregate;
using TheSchlote.TaskManager.Core.Services;
using TheSchlote.TaskManager.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace TheSchlote.TaskManager.UnitTests.Core.Services
{
